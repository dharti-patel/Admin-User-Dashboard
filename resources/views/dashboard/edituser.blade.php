    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="/update-user/{{$user->id}}">
                        @csrf
                        {{ method_field('PUT')}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mobile_no" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ $user->mobile_no }}" required autocomplete="mobile_no" maxlength="10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror" name="pincode" value="{{ $user->pincode }}" required autocomplete="pincode">
                        ...
                        <div class="form-group row offset-md-4">
                            ...
                            <a href="/display-users" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
